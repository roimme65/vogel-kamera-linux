...
def get_remote_video_command():
    ...
    return f"""
    mkdir -p /home/pi/Videos/Vogelhaus/{year}/{timestamp} && \
    cd /home/pi/Videos/Vogelhaus/{year}/{timestamp} && \
    ...
    arecord -D {audio_device} -f S16_LE -r 44100 -c 1 -t wav -d {recording_duration_s} /home/pi/Videos/Vogelhaus/{year}/{timestamp}/audio.wav
    """
...
def copy_files_from_remote():
    ...
    try:
        ...
        scp.get(f"/home/pi/Videos/Vogelhaus/{year}/{timestamp}/video.h264", base_path)
        scp.get(f"/home/pi/Videos/Vogelhaus/{year}/{timestamp}/audio.wav", base_path)
