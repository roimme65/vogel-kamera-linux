...
def get_remote_audio_command():
    return f"""
    mkdir -p /home/roimme/Audio/Kamerawagen/{year}/{timestamp} && \
    cd /home/roimme/Audio/Kamerawagen/{year}/{timestamp} && \
...
def copy_files_from_remote():
    ...
    try:
        ...
        scp.get(f"/home/roimme/Audio/Kamerawagen/{year}/{timestamp}/audio_{timestamp}.wav", base_path)
