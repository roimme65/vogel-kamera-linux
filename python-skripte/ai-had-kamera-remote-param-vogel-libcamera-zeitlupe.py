...
# Definiere den Pfad
base_path = f"/home/imme/Videos/Vogelhaus/Zeitlupe/{year}/{week_number}/{timestamp}"
...
def get_remote_video_command():
    ...
    return f"""
    mkdir -p /home/roimme/Videos/Kamerawagen/{year}/{timestamp} && \
    cd /home/roimme/Videos/Kamerawagen/{year}/{timestamp} && \
...
def copy_files_from_remote():
    ...
    try:
        ...
        scp.get(f"/home/roimme/Videos/Kamerawagen/{year}/{timestamp}/video.h264", base_path)
