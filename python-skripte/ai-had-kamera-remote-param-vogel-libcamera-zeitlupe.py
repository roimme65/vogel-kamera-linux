...
def get_remote_video_command():
    ...
    return f"""
    mkdir -p /home/pi/Videos/Kamerawagen/{year}/{timestamp} && \
    cd /home/pi/Videos/Kamerawagen/{year}/{timestamp} && \
...
def copy_files_from_remote():
    ...
    try:
        ...
        scp.get(f"/home/pi/Videos/Kamerawagen/{year}/{timestamp}/video.h264", base_path)
